package com.xpanxion.training.java.selenium.core.pageobject;
 ...
 * 
 * <p>This class is the intended root class for all Selenium Page Objects.  All pageobject objects should
 * extend this class, and provide the Selenium WebDriver object as an argument constructor to
 * interact with the current web pageobject.
 * 
 *
 */
public class PageObject {
	 ...
	 * 
	 * <p>This constructor assumes the required pageobject has already been opened and loaded.
	 *  
